...
-- for development
-- python
keymap.set("n", "<leader>py", ":!source .venv/bin/activate && python3 %<CR>") -- run python script
keymap.set("n", "<leader>vpy", ":!python3 -m venv .venv && source .venv/bin/activate<CR>") -- create virtual environment
keymap.set("n", "<leader>reqpy", ":!source .venv/bin/activate && pip install -r requirements.txt<CR>") -- install python requirements
